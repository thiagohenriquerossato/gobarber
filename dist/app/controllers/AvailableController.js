...
class AvailableController {
  async index(req, res) {
    ...
    const Appoinments = await _Appointment2.default.findAll({
      where: {
    ...
    const available = schedule.map((time) => {
      ...
      return {
        time,
        value: _datefns.format.call(void 0, value, "yyyy-MM-dd'T'HH:mmssxxx"),
        available:
          _datefns.isAfter.call(void 0, value, new Date()) &&
          !Appoinments.find((a) => _datefns.format.call(void 0, a.date, 'HH:mm') === time),
      };
    });
